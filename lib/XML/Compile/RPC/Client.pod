...
Returns the internal L<XML::Compile::RPC|XML::Compile::RPC> object.
...
is faster and safer. It implements "manually" what L<XML::Compile|XML::Compile> offers
...
This module is part of XML-Compile-RPC distribution version 0.14,
built on October 28, 2009. Website: F<http://perl.overmeer.net/xml-compile/>
